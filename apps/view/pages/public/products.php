...
//   return;
// }
if (isset($_GET['sponserid'])) {
  $_SESSION['sponserid'] = $_GET['sponserid'];
}
?>
<div  class="my-5">
            ...
            <div class="row">
              <div class="col-md-12">
                <ul style="display:none;" class="nav nav-pills my-3">
                  ...
                  $cats = $catobj->filter_index(['item_group' => 'category', 'show_to_cust' => 1]);
                  foreach ($cats as $cv) {
                    $cv = obj($cv);
                  ?>
                    <li class="nav-item me-2">
              ...
              ?>
                  <div class="col-md-3">
                    <form id="select-prod-form<?php echo $pv->id; ?>" action="/<?php echo home; ?>/public/add-to-cart-ajax" method="POST">
                      <div class="card product-card mb-4">
                        ...
                        <div class="card-footer d-flex justify-content-center bg-light border">
                          ...
                          <?php  } else { ?>
                            <button type="button" id="select-prod-btn<?php echo $pv->id; ?>" class="btn footer_btn btn-sm text-dark p-0">
                              Add To Cart
                            </button>
                          <?php }
                          ?>
